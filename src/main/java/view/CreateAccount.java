...
public class CreateAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<div style=\"display: inline-block; text-align: left;\"> CREATE ACCOUNT");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (aLogic.getAccountWithDisplayName(name) == null && aLogic.getAccountWithUser(user) == null && aLogic.getAccountWithPassword(password).isEmpty()) {
